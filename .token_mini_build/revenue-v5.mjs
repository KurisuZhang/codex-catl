...
s.images.add({blob:await fs.readFile(B+'/deepseek.png'),contentType:'image/png',alt:'DeepSeek 官方标识',fit:'contain',position:{left:1144,top:28,width: seventy(),height:70}});
