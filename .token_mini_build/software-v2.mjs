...
const ROOT='/Users/lin/Desktop/catl',B=ROOT+'/.token_mini_build/software-v2';
...
const t=table(s,[['分析案例','支持关系与限制','本项目判断'],
['T4 · 量化文本','vLLM 安装门槛包含 SM75 / T4 [5]\n仍须同时核验量化 kernel、注意力后端与显存 [6]','<20B 量化模型进入 PoC\nSGLang 的 T4 组合单独验证'],
['910B · 国产模型','vLLM Ascend 按 A2、模型、精度及特性列支持 [8]\nPyTorch / torch_npu / CANN 需保持版本配套 [4]','Qwen / DeepSeek / GLM 逐项筛选\n不把系列支持当成任意规格可部署'],
['T4 · YOLO / Wan','检测、视频生成走各自框架与推理管线\n文本引擎支持表不能代替视觉任务兼容验证','分别建镜像与质量 / 性能用例\nWan 另核验显存、卸载和耗时']],60,337,1160,[194,553,413],[35,60,60,60],19);
txt(s,'结论：两套可复现镜像基线，逐模型验收；容器启动成功与模型可售之间还有质量和性能门槛。',62,563,1156,48,23,C.teal,true);
